...
public class WebUI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String envHost = SystemUtils.getenv(WebUIConstants.ENV_NESSUS_JAXRS_ADDR, "127.0.0.1");
            String envPort = SystemUtils.getenv(WebUIConstants.ENV_NESSUS_JAXRS_PORT, "8081");
            ...
            envHost = SystemUtils.getenv(IPFSClient.ENV_IPFS_GATEWAY_ADDR, "127.0.0.1");
